...
function PuntosEntrega(props) {
  ...
  const [listaRetiros, setListaRetiros] = React.useState(
    props.puntoRetiro,
  );
          ...
          <CardContent className="cardContentePromo">
            <Grid item xs={12} md={12}>
              <div className={classes.demo}>
                <List>
                  {props.puntoRetiro && texto === false
                    ? props.puntoRetiro.map((punto) => {
                        return (
                          <ListItem key={punto.id}>
                            ...
                            <ListItemSecondaryAction>
                              ...
                              <DialogComponent
                                ...
                                title={
                                  '¿Estás seguro de eliminar el punto de retiro?'
                                }
                                text={
