    ...
    <div>
      ...
      <div className={classes.root}>
        <AccordionPreguntas
          ...
          En el caso que desees crear una estadística específica, deberás dirigirte a la deseada seleccionar el período deseado y completar cualquier otro dato adicional que se requiera, y presionar en el botón
          'Actualizar'.
          "
        />
        <AccordionPreguntas
        ...
        <AccordionPreguntas
          ...
          Por otro lado, si tu plan incluye dicha funcionalidad, una vez creada la estadística deseada deberás seleccionar la opción “Imprimir”. Se te abrirá una ventana para que almacenes el reporte en la ubicación deseada de tu computadora con un nombre de preferencia.
          "
        />
        <AccordionPreguntas
